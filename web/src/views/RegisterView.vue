        ...
        <form @submit.prevent="save">
          <div class="border-b border-gray-900/10 w-full">
            <div class="flex flex-col w-full">
              <div class="w-full">
                <label for="first-name" class="block text-sm/6 font-medium text-gray-900 w-full">Nome Completo</label>
                <div class="mt-2 w-full">
                  <input v-model="user.name" type="text" name="first-name" id="first-name" autocomplete="given-name"
          ...
          <div class="mt-6 flex flex-col items-center justify-end gap-4 ">
            <button type="submit"
              class="rounded-md bg-primary text-sm font-semibold p-2 text-white shadow-xs w-full hover:bg-secondary">Registrar</button>
            <a href="/login" class="text-sm/6 italic text-gray-500 underline hover:text-primary">Efetuar Login</a>
          </div>
        </form>
      </div>
    </div>
